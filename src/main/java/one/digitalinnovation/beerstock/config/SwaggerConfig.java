...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Teste";
    private static final String CONTACT_GITHUB = "https://gtihub.com/teste123";
    private static final String CONTACT_EMAIL = "teste@hotmail.com";
